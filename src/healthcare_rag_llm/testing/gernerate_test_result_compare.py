...
aligned_pairs, similarities, differences, caveats, plus legacy
policy_definition / provider_manual_definition only when non-empty) —
...
Example usage:
.venv/bin/python -m healthcare_rag_llm.testing.gernerate_test_result_compare \
